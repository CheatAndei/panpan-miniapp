...
.streak-card {
  ...
  border-radius: var(--r);
  background:
    linear-gradient(rgba(233, 133, 119, .07) 1rpx, transparent 1rpx),
    linear-gradient(145deg, #FFFFFF, var(--primary-soft));
