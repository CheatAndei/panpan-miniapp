...
.streak-card {
  ...
  border-radius: var(--r);
  background:
    linear-gradient(rgba(247, 155, 192, .07) 1rpx, transparent 1rpx),
    linear-gradient(145deg, #FFFFFF, var(--primary-soft));
