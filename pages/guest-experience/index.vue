...
.title-icon.tone-coral { background: #FFF0ED; }
...
.tabs {
  ...
  border-radius: 13rpx;
  background: #FFFFFF;
  box-shadow: 0 7rpx 18rpx rgba(36, 50, 74, .05);
}
...
.tab.on { background: var(--panpan-green-strong); color: #FFFFFF; box-shadow: 0 6rpx 12rpx rgba(49, 94, 168, .18); }
...
.counter { padding: 4rpx 9rpx; border-radius: 7rpx; background: #EAF2FF; color: #315EA8; font-size: 20rpx; font-weight: 680; }
...
.option.selected { border-color: var(--panpan-green); background: #EAF2FF; }
.option.correct { border-color: var(--panpan-green); background: #EAF2FF; }
.option.wrong { border-color: var(--panpan-coral); background: #FFF0ED; }
.result-strip { margin-top: 17rpx; padding: 17rpx; border-left: 5rpx solid var(--panpan-green); border-radius: 9rpx; background: #EAF2FF; }
.result-strip.bad { border-left-color: var(--panpan-coral); background: #FFF0ED; }
.result-title,
.result-copy { display: block; }
.result-title { color: var(--panpan-green-strong); font-size: 26rpx; font-weight: 800; }
.bad .result-title { color: #D66D62; }
.result-copy { margin-top: 6rpx; color: #5C6C84; font-size: 22rpx; line-height: 1.58; }
...
.primary {
  ...
  font-size: 26rpx;
  font-weight: 760;
  box-shadow: 0 8rpx 18rpx rgba(49, 94, 168, .2);
...
.answer-input { height: 88rpx; border: 2rpx solid #D9E5F3; border-radius: 11rpx; background: #F6FAFF; color: var(--panpan-ink); font-size: 36rpx; text-align: center; }
.sample-tag { display: inline-flex; padding: 7rpx 13rpx; border-radius: 7rpx; background: #EAF2FF; color: #315EA8; font-size: 20rpx; font-weight: 760; }
...
.challenge-stem { display: block; margin-top: 14rpx; color: #5C6C84; font-size: 26rpx; line-height: 1.82; }
.challenge-flow { display: flex; flex-wrap: wrap; gap: 9rpx; margin-top: 20rpx; padding: 16rpx; border-left: 5rpx solid var(--panpan-sprout); border-radius: 9rpx; background: #EAF2FF; color: #315EA8; font-size: 21rpx; font-weight: 700; }
.privacy-note { display: block; margin-top: 15rpx; color: var(--panpan-muted); font-size: 21rpx; line-height: 1.58; }

.locked-card { border-style: dashed; background: #F6FAFF; }
.locked-title,
...
.wechat { display: block; margin-top: 9rpx; color: #5C6C84; font-size: 24rpx; }
.copy-btn,
...
.copy-btn { background: var(--panpan-green-strong); color: #FFFFFF; box-shadow: 0 8rpx 16rpx rgba(49, 94, 168, .18); }
.bind-btn { border: 1rpx solid rgba(82, 124, 201, .3); background: #EAF2FF; color: #315EA8; }
