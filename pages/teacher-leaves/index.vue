...
<view class="page page-bottom-safe">
  <view class="inbox-hero">
    <view class="hero-meta">
      ...
      <view class="pending-count"><text class="num">{{ pending.length }}</text><text>待处理</text></view>
    </view>
...
.empty-state-card { border-top-color: var(--accent, #65BFA8); }
