...
.hero {
  ...
  border-radius: 16rpx;
  background:
    repeating-linear-gradient(0deg, transparent 0 47rpx, rgba(153, 222, 244, .05) 48rpx 49rpx),
    #FFFFFF;
  box-shadow: 0 9rpx 22rpx rgba(5, 5, 5, .06);
  animation: homework-enter var(--motion-slow) var(--ease-out) both;
}

.eyebrow { display: inline-flex; padding: 5rpx 12rpx; border-radius: 7rpx; background: #E5F8FE; color: var(--panpan-green-strong); font-size: 21rpx; font-weight: 700; letter-spacing: 0; }
...
.hero-sub { display: flex; align-items: center; gap: 7rpx; margin-top: 7rpx; color: #050505; font-size: 24rpx; font-weight: 650; }
...
.score-pill { display: flex; align-items: center; gap: 5rpx; flex: none; padding: 7rpx 14rpx; border: 1rpx solid rgba(153, 222, 244, .24); border-radius: 8rpx; background: #E5F8FE; color: #050505; font-weight: 720; }
.batch-foot { margin-top: 17rpx; padding-top: 15rpx; border-top: 1rpx solid #EDF3F5; color: var(--panpan-muted); font-size: 23rpx; }
.batch-foot text:first-child { color: #050505; font-weight: 650; }
.detail-link { display: flex; align-items: center; gap: 4rpx; color: var(--panpan-green-strong); font-weight: 680; }

.modal-mask { position: fixed; inset: 0; z-index: 99; display: flex; align-items: flex-end; background: rgba(5, 5, 5, .42); animation: homework-mask-in var(--motion-base) ease-out both; }
.modal { width: 100%; max-height: 90vh; box-sizing: border-box; padding: 26rpx 24rpx calc(22rpx + env(safe-area-inset-bottom)); border-radius: 16rpx 16rpx 0 0; background: #FFFFFF; box-shadow: 0 -12rpx 30rpx rgba(5, 5, 5, .1); animation: homework-sheet-in var(--motion-slow) var(--ease-out) both; }
...
.summary { margin-bottom: 14rpx; padding: 17rpx; border: 1rpx solid rgba(153, 222, 244, .22); border-left: 6rpx solid var(--panpan-green); border-radius: 10rpx; background: #E5F8FE; color: #50545B; font-size: 25rpx; line-height: 1.66; }
.answer-card { margin-bottom: 0; padding: 19rpx 0; border-bottom: 1rpx solid #EDF3F5; border-radius: 0; background: transparent; }
...
.answer-status.correct { color: var(--panpan-green-strong); background: #E5F8FE; }
.answer-status.wrong { color: #B53A52; background: #FFF0F6; }
.question-image { width: 100%; margin-top: 14rpx; border: 1rpx solid #DCE9ED; border-radius: 10rpx; background: var(--panpan-paper); }
.answer-line { display: flex; gap: 14rpx; margin-top: 12rpx; color: #50545B; font-size: 24rpx; line-height: 1.58; }
.label { flex-shrink: 0; color: var(--panpan-muted); }
.comment { margin-top: 14rpx; padding: 14rpx; border-left: 5rpx solid var(--panpan-coral); border-radius: 9rpx; background: #FFF0F6; color: #B53A52; font-size: 24rpx; line-height: 1.58; }
