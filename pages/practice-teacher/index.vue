...
.page {
  ...
  background-image: repeating-linear-gradient(0deg, transparent 0 63rpx, rgba(153, 222, 244, .045) 64rpx 65rpx);
}
.hero {
  display: flex;
  align-items: center;
...
.eyebrow { display: inline-flex; padding: 5rpx 11rpx; border-radius: 7rpx; background: #E5F8FE; color: var(--panpan-green-strong); font-size: 18rpx; font-weight: 760; letter-spacing: 0; }
...
.review-entry { width: 170rpx; min-height: 82rpx; display: flex; align-items: center; justify-content: center; gap: 9rpx; flex: none; margin: 0; padding: 7rpx 10rpx; border: 2rpx solid var(--panpan-coral); border-radius: 12rpx; background: #FFF0F6; color: var(--panpan-coral-strong); font-size: 19rpx; box-shadow: 0 7rpx 16rpx rgba(217, 75, 69, .1); }
...
.card { margin-bottom: 15rpx; padding: 23rpx 24rpx; border: 1rpx solid #DCE9ED; border-radius: 14rpx; background: #FFFFFF; box-shadow: 0 8rpx 20rpx rgba(5, 5, 5, .06); }
...
.field-label { display: block; margin: 17rpx 0 8rpx; color: #50545B; font-size: 23rpx; font-weight: 680; }
.field { box-sizing: border-box; width: 100%; min-height: 82rpx; padding: 0 18rpx; border: 1rpx solid #DCE9ED; border-radius: 10rpx; background: #F7FCFE; color: var(--panpan-ink); font-size: 26rpx; }
...
.fixed-scope { margin-top: 19rpx; padding: 16rpx 0 16rpx 18rpx; border: 0; border-left: 6rpx solid var(--panpan-green); border-radius: 0; background: #E5F8FE; }
.fixed-scope-title { display: block; color: var(--panpan-green-strong); font-size: 26rpx; font-weight: 730; }
.fixed-scope-copy { display: block; margin-top: 6rpx; padding-right: 18rpx; color: #50545B; font-size: 21rpx; line-height: 1.52; }
.topic-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 9rpx; margin: 14rpx 18rpx 0 0; }
.topic-option { min-height: 78rpx; display: flex; align-items: center; gap: 9rpx; margin: 0; padding: 9rpx 11rpx; border: 1rpx solid #DCE9ED; border-radius: 10rpx; background: #FFFFFF; text-align: left; }
.topic-option::after { border: 0; }
.topic-option.selected { border-color: var(--panpan-green); background: #E5F8FE; }
.topic-check { width: 30rpx; height: 30rpx; display: flex; align-items: center; justify-content: center; flex: none; border: 2rpx solid #C7DDE4; border-radius: 8rpx; color: #FFFFFF; }
...
.preview-box { margin-top: 18rpx; padding: 15rpx 17rpx; border-left: 6rpx solid var(--panpan-green); border-radius: 9rpx; background: #E5F8FE; }
...
.preview-copy { display: block; margin-top: 5rpx; color: #50545B; font-size: 21rpx; }
...
.primary-btn { background: var(--panpan-green-strong); color: #FFFFFF; box-shadow: 0 8rpx 18rpx rgba(5, 5, 5, .18); }
...
.search-input { flex: 1; height: 76rpx; padding: 0 16rpx; border: 1rpx solid #DCE9ED; border-radius: 10rpx; background: #F7FCFE; color: var(--panpan-ink); font-size: 23rpx; }
...
.filter-field { min-height: 66rpx; display: flex; align-items: center; justify-content: space-between; gap: 5rpx; padding: 0 10rpx; border: 1rpx solid #DCE9ED; border-radius: 9rpx; background: #F8FCFD; color: #50545B; font-size: 20rpx; }

.plan-item { margin-top: 0; border: 0; border-bottom: 1rpx solid #DCE9ED; border-radius: 0; background: transparent; overflow: hidden; }
.plan-item.active { border-left: 5rpx solid var(--panpan-green); background: #F8FCFD; box-shadow: none; }
...
.status-pill { flex: none; padding: 4rpx 9rpx; border-radius: 7rpx; background: #E5F8FE; color: var(--panpan-green-strong); font-size: 17rpx; font-weight: 700; }
.status-pill.upcoming { background: #E5F8FE; color: var(--panpan-green-strong); }
.status-pill.ended { background: #F8FCFD; color: #50545B; }
...
.plan-detail { padding: 0 14rpx 14rpx; border-top: 1rpx solid #DCE9ED; background: transparent; }
...
.plan-action.review { border: 1rpx solid #F2C8D5; background: #FFF0F6; color: var(--panpan-coral-strong); }
.plan-action.pdf { background: #E5F8FE; color: var(--panpan-green-strong); }
.history-title { display: block; margin: 6rpx 0 4rpx; color: var(--panpan-ink); font-size: 22rpx; font-weight: 720; }
.history-row { box-sizing: border-box; width: 100%; min-height: 74rpx; display: flex; align-items: center; justify-content: space-between; gap: 12rpx; margin: 0; padding: 10rpx 0; border: 0; border-top: 1rpx solid #DCE9ED; border-radius: 0; background: transparent; line-height: 1.38; text-align: left; }
...
.old-toggle { min-height: 72rpx; margin: 15rpx 0 0; border: 1rpx dashed #C7DDE4; border-radius: 9rpx; background: #F7FCFE; color: var(--panpan-green-strong); font-size: 22rpx; }
