...
.progress-head { color: var(--text-secondary); }
...
.question-card {
  ...
  animation: challenge-card-in var(--motion-slow) var(--ease-out) both;
}

.question-type { color: var(--primary-strong); }
...
.answer-tip,
.question-report,
.early-submit { color: var(--text-muted); }
...
.number-dot.current {
  ...
  background: var(--warning-soft);
  color: #765410;
  box-shadow: 0 0 0 3rpx rgba(244, 199, 91, .2);
}
