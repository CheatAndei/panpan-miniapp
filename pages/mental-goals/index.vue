...
.picker-row,
.rank-row { background: #F7FCFE; border: 1rpx solid var(--border); }
...
.save-btn {
  ...
  color: #FFFFFF;
  box-shadow: 0 12rpx 26rpx rgba(5, 5, 5, .18);
}
.goal-card {
  border-color: var(--border);
  background: #FFFFFF;
