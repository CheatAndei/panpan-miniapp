...
.hero {
  ...
  background-image: repeating-linear-gradient(
    ...
    transparent 0,
    transparent 51rpx,
    rgba(153, 222, 244, 0.055) 52rpx,
    rgba(153, 222, 244, 0.055) 53rpx
  );
  box-shadow: 0 12rpx 30rpx rgba(5, 5, 5, 0.08);
...
.hero::before {
  ...
  left: 56rpx;
  width: 2rpx;
  background: rgba(247, 155, 192, 0.28);
}
...
.paper-hole {
  ...
  border-radius: 50%;
  background: #F7FCFE;
  box-shadow: inset 0 2rpx 3rpx rgba(5, 5, 5, 0.08);
}
...
.section-index {
  ...
  flex: none;
  border-bottom: 5rpx solid var(--gold, #0B789A);
  color: var(--primary-strong, #050505);
  font-size: 25rpx;
  font-weight: 800;
...
.tool-card {
  ...
  border-left: 6rpx solid var(--primary, #0B789A);
  border-radius: 14rpx;
  background: #ffffff;
  color: var(--ink, #050505);
  text-align: left;
  line-height: normal;
  box-shadow: 0 7rpx 18rpx rgba(5, 5, 5, 0.055);
  box-sizing: border-box;
...
.tool-number {
  ...
  flex: none;
  padding-right: 10rpx;
  border-right: 1rpx solid var(--border, #DCE9ED);
  color: #50545B;
  font-size: 20rpx;
  font-weight: 800;
  font-variant-numeric: tabular-nums;
...
.fair-note {
  ...
  background-image: repeating-linear-gradient(
    ...
    transparent 0,
    transparent 47rpx,
    rgba(153, 222, 244, 0.06) 48rpx,
    rgba(153, 222, 244, 0.06) 49rpx
  );
...
.hero {
  ...
  background-image: repeating-linear-gradient(
    ...
    transparent 0,
    transparent 51rpx,
    rgba(153, 222, 244, .055) 52rpx,
    rgba(153, 222, 244, .055) 53rpx
  );
  box-shadow: 0 8rpx 22rpx rgba(5, 5, 5, .07);
}
.hero::before {
  left: 48rpx;
...
.hero-rule { background: #0B789A; }
.hero-code { color: #50545B; }
.section-kicker { color: #050505; }
.section-title { color: #050505; }
.section-index {
  border-bottom-color: #0B789A;
  color: #050505;
}
.tool-list {
...
.tool-card-3,
.tool-card-5,
.tool-card-6 { border-left-color: #0B789A; }
.tool-card-4 { border-left-color: #F79BC0; }
.tool-card-7 { border-left-color: #0B789A; }
.tool-number {
...
.tool-title { color: #050505; }
.tool-desc { color: #50545B; }
.tool-priority {
  border-color: #C7DDE4;
  background: #E5F8FE;
  color: #050505;
}
.tool-arrow { color: #050505; }
.fair-note {
  ...
  background-image: repeating-linear-gradient(
    ...
    transparent 0,
    transparent 47rpx,
    rgba(153, 222, 244, .06) 48rpx,
    rgba(153, 222, 244, .06) 49rpx
  );
}
.note-tab {
  background: #0B789A;
...
.note-mark { background: #0B789A; }
.note-title { color: #050505; }
.note-copy { color: #50545B; }
</style>
