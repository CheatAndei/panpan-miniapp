...
.hero {
  ...
  border: 0;
  border-bottom: 1rpx solid #D8E6DD;
...
.hero-summary > view:nth-child(1) { background: #F7FCF9; }
.hero-summary > view:nth-child(2) { background: #F7FCF9; }
.hero-summary > view:nth-child(3) { background: #FFF0EE; }
.hero-summary > view:nth-child(1) .summary-number { color: #15946D; }
.hero-summary > view:nth-child(2) .summary-number { color: #15946D; }
.hero-summary > view:nth-child(3) .summary-number { color: #B44E47; }
.state-wrap {
  border-color: #D8E6DD;
  border-radius: 14rpx;
}
...
.student-record {
  ...
  border-radius: 14rpx;
  background: #FFFFFF;
  box-shadow: 0 5rpx 15rpx rgba(36, 48, 41, .045);
}
...
.student-metrics > view:nth-child(1) .metric-value { color: #15946D; }
.student-metrics > view:nth-child(2) .metric-value { color: #15946D; }
.student-metrics > view:nth-child(3) .metric-value { color: #15946D; }
.student-metrics > view:nth-child(4) .metric-value { color: #15946D; }
.back-to-list {
  height: 64rpx;
  min-height: 0;
  padding: 0 17rpx;
...
.overview-kicker { color: #15946D; }
.overview-number { color: #26352F; }
.overview-secondary {
...
.overview-secondary > view {
  ...
  padding: 14rpx;
  border-right: 1rpx solid #E7EFEA;
  border-bottom: 0;
}
.overview-secondary > view:nth-child(1) { background: #FFF0EE; }
.overview-secondary > view:nth-child(2) { background: #F7FCF9; }
.overview-secondary > view:nth-child(3) { background: #F7FCF9; }
.channel-grid { align-content: start; }
.channel-card {
  align-self: start;
  padding: 17rpx;
  border-color: #D8E6DD;
  border-top: 5rpx solid #20B486;
  border-radius: 12rpx;
}
.channel-card.tone-blue { border-top-color: #20B486; }
.channel-card.tone-coral { border-top-color: #FF7468; }
.channel-card.tone-yellow { border-top-color: #20B486; }
.channel-card.tone-mint { border-top-color: #20B486; }
.channel-card.tone-purple { border-top-color: #20B486; }
...
.answer-row text:first-child { color: #15946D; }
