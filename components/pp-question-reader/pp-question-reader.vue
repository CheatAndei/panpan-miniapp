...
.reader-heading-icon { width: 46rpx; height: 46rpx; display: flex; align-items: center; justify-content: center; flex: none; border-radius: 10rpx; background: #E7F8F1; }
.reader-label,
.reader-hint { display: block; }
.reader-label { color: #26352F; font-size: 23rpx; font-weight: 760; }
.reader-hint { max-width: 340rpx; margin-top: 3rpx; color: #5A6A62; font-size: 18rpx; line-height: 1.4; }
.reader-modes { display: flex; flex: none; padding: 4rpx; border: 1rpx solid #CFE2D7; border-radius: 10rpx; background: #FFFFFF; }
.reader-mode { min-height: 56rpx; margin: 0; padding: 0 12rpx; border-radius: 7rpx; background: transparent; color: #5A6A62; font-size: 19rpx; font-weight: 650; line-height: 56rpx; }
.reader-mode::after,
.reader-retry::after { border: 0; }
.reader-mode.active { background: #E7F8F1; color: #15946D; }
.reader-mode:active,
...
.reader-state { min-height: 180rpx; display: flex; flex-direction: column; align-items: center; justify-content: center; border-radius: 10rpx; background: #FFFFFF; color: #5A6A62; font-size: 21rpx; }
.reader-skeleton { width: 86%; height: 112rpx; margin-bottom: 16rpx; border-radius: 8rpx; background: linear-gradient(100deg, #E1ECE6 20%, #F8FCF9 40%, #E1ECE6 60%); background-size: 200% 100%; animation: reader-shimmer 1.2s linear infinite; }
.reader-error { padding: 22rpx; text-align: center; background: #FFF0EE; }
.reader-error-title { color: #D94B45; font-size: 24rpx; font-weight: 740; }
.reader-error-copy { max-width: 480rpx; margin-top: 6rpx; color: #5A6A62; font-size: 20rpx; line-height: 1.5; }
.reader-retry { min-height: 72rpx; margin: 16rpx 0 0; padding: 0 22rpx; border: 1rpx solid #FFB9B3; border-radius: 8rpx; background: #FFFFFF; color: #D94B45; font-size: 21rpx; line-height: 72rpx; }
.reader-preview-tip { display: block; padding: 13rpx 4rpx 2rpx; color: #15946D; font-size: 19rpx; text-align: center; }
